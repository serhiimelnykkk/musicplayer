...
export const VolumeSlider = () => {
  const { volume, setVolume } = useCurrentSong(
    useShallow((state) => ({
      volume: state.volume,
  ...
  return (
    ...
    >
      ...
      <Thumb
        className="relative focus:outline-0 opacity-0 group-hover/root:opacity-100 block size-4 bg-neutral-300 rounded-full group"
